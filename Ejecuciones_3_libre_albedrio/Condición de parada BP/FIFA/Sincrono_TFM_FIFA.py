...
class FFNN:
    ...
    def run_and_test(self):
        ...
        while self.current_epochs < self.n_epochs:
            ...
            fitness_array.append(new_fitness)
...
if __name__ == "__main__":
    ...
    max_iterations = 1               	# Maximum iterations allowed for the evolutionary process
    population_size = 1                 # Number of individuals
    ...
    for n_exe in range(50):
        ...
        time_2 = time.time()
        # Saving files
        n_file_1 = './Entrenamiento_Individuo_' + str(n_exe) + '.csv'
        savetxt(n_file_1, evo.population[0].fitness, delimiter=',')
        evo = []