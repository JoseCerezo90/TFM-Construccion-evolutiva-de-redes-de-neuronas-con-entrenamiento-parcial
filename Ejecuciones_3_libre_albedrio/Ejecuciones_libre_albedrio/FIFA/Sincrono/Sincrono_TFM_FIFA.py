...
class FFNN:
    ...
    def run_and_test(self):
        ...
        while keep_training:
            ...
            if percent_improv < 0.05: self.BP_not_improving += 1
...
if __name__ == "__main__":
    ...
    # Saving files
    n_exe = 18
    n_file_1 = './FIFA_Sync_Best_Fit_' + str(n_exe) + '.csv'
    n_file_2 = './FIFA_Sync_Aver_Fit_' + str(n_exe) + '.csv'
    n_file_3 = './FIFA_Sync_Epochs_' + str(n_exe) + '.csv'
    n_file_4 = './FIFA_Sync_TOP_Fit_' + str(n_exe) + '.csv'
    txt_file = 'FIFA_Sync_' + str(n_exe) + '.txt'
