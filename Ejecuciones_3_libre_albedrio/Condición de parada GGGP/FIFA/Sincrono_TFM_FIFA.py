...
class FFNN:
    ...
    def run_and_test(self):
        global total_epochs
        while self.current_epochs < self.n_epochs:
...
if __name__ == "__main__":
    ...
    max_iterations = 20            	    # Maximum iterations allowed for the evolutionary process
    ...
    for n_exe in range(10):
        ...
        time_2 = time.time()
        # Saving files
        n_file_1 = './Mejores_Individuos_' + str(n_exe) + '.csv'
        savetxt(n_file_1, evo.array_TOP_best_fitness, delimiter=',')
        evo = []