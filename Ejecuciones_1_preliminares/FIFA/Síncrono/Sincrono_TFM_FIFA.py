...
if __name__ == "__main__":
    ...
    # Saving files
    if "FIFA" in file_1:
        n_file_1 = './FIFA_Sync_Best_Fit_10.csv'
        n_file_2 = './FIFA_Sync_Aver_Fit_10.csv'
        txt_file = 'FIFA_Sync_10.txt'
    else:
        n_file_1 = './MedianHouseValue_Sync_Best_Fit_10.csv'
        n_file_2 = './MedianHouseValue_Sync_Aver_Fit_10.csv'
        txt_file = 'MedianHouseValue_Sync_10.txt'
